...
$root.tflite.CustomQuantization = class CustomQuantization {
    ...
    get custom() {
        ...
        return offset ? new Uint8Array(this._reader.buffer.buffer, this._reader.buffer.byteOffset + this._reader.vector(this._offset + offset), this._reader.length(this._offset + offset)) : new Uint8Array(0);
    }
};
...
$root.tflite.QuantizationParameters = class QuantizationParameters {
    ...
    get min() {
        const offset = this._reader.offset(this._offset, 4);
        return offset ? new Float32Array(this._reader.buffer.buffer, this._reader.buffer.byteOffset + this._reader.vector(this._offset + offset), this._reader.length(this._offset + offset)) : new Float32Array(0);
    }
...
$root.tflite.Int32Vector = class Int32Vector {
    ...
    get values() {
        const offset = this._reader.offset(this._offset, 4);
        return offset ? new Int32Array(this._reader.buffer.buffer, this._reader.buffer.byteOffset + this._reader.vector(this._offset + offset), this._reader.length(this._offset + offset)) : new Int32Array(0);
    }
};
...
$root.tflite.Uint16Vector = class Uint16Vector {
    ...
    get values() {
        const offset = this._reader.offset(this._offset, 4);
        return offset ? new Uint16Array(this._reader.buffer.buffer, this._reader.buffer.byteOffset + this._reader.vector(this._offset + offset), this._reader.length(this._offset + offset)) : new Uint16Array(0);
    }
};
...
$root.tflite.BoundingBoxProperties = class BoundingBoxProperties {
    ...
    get index() {
        const offset = this._reader.offset(this._offset, 4);
        return offset ? new Uint32Array(this._reader.buffer.buffer, this._reader.buffer.byteOffset + this._reader.vector(this._offset + offset), this._reader.length(this._offset + offset)) : new Uint32Array(0);
    }
